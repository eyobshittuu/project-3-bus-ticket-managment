		...
		<div class='row' style='margin:0;padding:0;border-radius:0px;' id="index">
							...
							<div class="container" style='font-weight:bold;'>
								...
								<label style="margin-left:px;font-style:bold;color:black">From:</label>
									<select  style="margin-top:px;color:#333333;"  class='form-control' id="source" name="source">
										...
										<option value="addis">gambella</option>
										<option value="addis">gonder</option>
			...
			<div class='container-fluid' id='info'>
				...
				<div class='row' style='margin:0;padding:0;list-style:none'>
					<div class='col-lg-3'>
						<li><img src="icon/location1.png"  style="width:25px;height:15px;margin-top:-4px;">harar-addis</li>
						<li><img src="icon/location1.png"  style="width:25px;height:15px;margin-top:-4px;">addis-harar</li>
						<li><img src="icon/location1.png"  style="width:25px;height:15px;margin-top:-4px;">addis-diredawa</li>
						<li><img src="icon/location1.png"  style="width:25px;height:15px;margin-top:-4px;">addis-assela</li>
						<li><img src="icon/location1.png"  style="width:25px;height:15px;margin-top:-4px;"></li>
						<li><img src="icon/location1.png"  style="width:25px;height:15px;margin-top:-4px;">assela - Chattagram</li>
					</div>
					<div class='col-lg-3'>
						<li><img src="icon/location1.png"  style="width:25px;height:15px;margin-top:-4px;">addis - Harar</li>
						<li><img src="icon/location1.png"  style="width:25px;height:15px;margin-top:-4px;">addis - assela</li>
						<li><img src="icon/location1.png"  style="width:25px;height:15px;margin-top:-4px;">addis - gambella</li>
						<li><img src="icon/location1.png"  style="width:25px;height:15px;margin-top:-4px;">addis - afar</li>
						<li><img src="icon/location1.png"  style="width:25px;height:15px;margin-top:-4px;">Harar - jigjiga</li>
						<li><img src="icon/location1.png"  style="width:25px;height:15px;margin-top:-4px;">assela - mekele</li>
					</div>
					<div class='col-lg-3'>
						<li><img src="icon/location1.png"  style="width:25px;height:15px;margin-top:-4px;">addis - Harar</li>
						<li><img src="icon/location1.png"  style="width:25px;height:15px;margin-top:-4px;">addis - assela</li>
						<li><img src="icon/location1.png"  style="width:25px;height:15px;margin-top:-4px;">addis - addis</li>
						<li><img src="icon/location1.png"  style="width:25px;height:15px;margin-top:-4px;">addis - gonder</li>
						<li><img src="icon/location1.png"  style="width:25px;height:15px;margin-top:-4px;">Harar - addis</li>
						<li><img src="icon/location1.png"  style="width:25px;height:15px;margin-top:-4px;">assela - harar</li>
					</div>
				</div>
			</div>
			<div class='container-fluid' id='info'>
